...
class JobController {
	...
	init() {
        ...
        let job5 = Job(id: 4, name: "Fence Painting", timeFrameStart: "Jun 12, 2017", timeFrameEnd: "Jun 12, 2017", priceRangeStart: 50, priceRangeEnd: 150, industry: "Yardwork", locationCity: nil, locationState: "UT", locationZip: "83713", description: "Lorem ipsum dolor sit amet, laoreet proin mauris dui hymenaeos mi dictumst, etiam consectetuer lectus morbi turpis vulputate, lectus rutrum a landit, eu tincidunt ridiculus.", images: nil, advertiser: user3)
