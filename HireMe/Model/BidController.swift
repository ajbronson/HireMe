...
class BidController {
	...
	init() {
		...
		let bid2 = Bid(user: "Nate", price: 235, description: "Lorem ipsum dolor sit amet, laoreet proin mauris dui hymenaeos mi dictumst, etiam consectetuer lectus morbi turpis vulputate, lectus rutrum a landit, eu tincidunt ridiculus. Inceptos feugi END")
		...
		let bid5 = Bid(user: "Bryan de la joya de la maria que me pario entonces tu sabes lo que pasa", price: 2225.35, description: "I can do this pretty well END", status: BidStatus.PendingResponse.rawValue)
